	...
	if not $"../ErosionActor".is_node_ready():
		...
		for x in 16:
			for y in 16:
				...
				data._import_map(3, "res://data/tiles/height_%d_%d.png" % [x, y])
				@warning_ignore("unused_variable")
